...
public class Print extends javax.swing.JFrame {
    ...
    public Print() {
        initComponents();
        jTable1.getTableHeader().setFont(new Font("Cambria", Font.PLAIN, 15));//Sold Product Font Details
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        PrinterJob job = PrinterJob.getPrinterJob();//Show Detailed Report of Sold Products
